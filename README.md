...
- **create <name>** — генерация нового файла миграции (обычно создает пустой шаблон с меткой времени в названии).
...
- **status** — вывод списка примененных и пропущенных миграций.
